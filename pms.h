...
void RASLite::update_goodvarstack1(int flipvar)
{
	int v;
...
void RASLite::update_goodvarstack2(int flipvar)
{
...
void RASLite::print_best_solution()
{
...
inline void RASLite::unsat(int clause)
{
...
inline void RASLite::sat(int clause)
{
