...
void RASLite::build_neighbor_relation()
{
    int i, j, count;
    int v, c, n;
...
void RASLite::build_instance(char *filename)
{
    istringstream iss;
    string line;
    char tempstr1[10];
