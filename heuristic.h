...
void RASLite::init(vector<int> &init_solution)
{
...
void RASLite::local_search(char *inputfile)
{
...
void RASLite::local_search_with_decimation(char *inputfile)
{
    settings();
...
void RASLite::update_clause_weights()
{
